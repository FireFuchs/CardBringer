...
namespace CardBringer2
{
    public partial class NovaKartaAdmin : Form
    {
        ...
        private void buttonSpremiKartu_Click(object sender, EventArgs e)
        {
            ...
            var unosImeKarte = this.unosImeKarte.Text;
            var unosOpisKarte = this.unosOpisKarte.Text;

            var db = new DbInteraction();
            db.Connection.Open();
            var dataAdapter = new SqlDataAdapter();
            var sql = $"INSERT INTO karta(imeKarte, opisKarte, slikaKarte) VALUES('{unosImeKarte}','{unosOpisKarte}','{blobName}')";
